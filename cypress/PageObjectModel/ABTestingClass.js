...
class ABTesting{
    ...
    MakeLPvariants()
    {
        cy.get('.bkg-ylb').realHover().click()
        cy.get('.selectBtn').click().wait(3000)
        cy.get('#duplicate-A').click().wait(2000)
        cy.get('.swal2-confirm').realHover().wait(2000).click().wait(3000)
        cy.get('#back-to-dashboard > .lpb-md').click().realMouseMove(200,200).wait(3000)
    }
    CreateABTest()
    {
        cy.get('.bkg-ylb').realHover().wait(2000).click().wait(2000)
        cy.get('#ab_test_title').type('AB Test 01').wait(2000)
        cy.get('.bg-teal-500').realHover().wait(2000).click().wait(7000)
    }
    EndTest()
    {
        cy.get('.inline-flex').realHover().wait(3000).click().wait(5000)
    }
    PreviousTests()
    {
