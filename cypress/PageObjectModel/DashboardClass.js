...
class Dashboard{
    ...
    OpenModules()
    {
        ...
        cy.get('body').should('have.css', 'font').and('include','Poppins')
        cy.contains('Project Settings').realHover({scrollBehavior:false}).wait(2000).should('have.css','background-color','rgb(244, 245, 247)')
        .click({scrollBehavior:false}).realMouseMove(200,200).wait(2000)
        cy.get('body').should('have.css', 'font').and('include','Poppins')
        ...
        // Funnel Builder
        cy.get(':nth-child(1) > .text-right').click({scrollBehavior:false}).wait(2000)
        cy.contains('Funnel Builder').realHover({scrollBehavior:false}).wait(2000).should('have.css','background-color','rgb(244, 245, 247)')
        .click({scrollBehavior:false}).realMouseMove(200,200).wait(3000)
        cy.url().should('include','/ui-editor').wait(1000)
        cy.go(-1).wait(3000)
        // Analytics dashboard
        cy.get(':nth-child(1) > .text-right').click({scrollBehavior:false}).wait(2000)
        cy.contains('Analytics Dashboard').realHover({scrollBehavior:false}).wait(2000).should('have.css','background-color','rgb(244, 245, 247)')
        .click({scrollBehavior:false}).realMouseMove(200,200).wait(3000)
        cy.get('body').should('have.css', 'font').and('include','Poppins')
        ...
        // Ad Analytics
        cy.get(':nth-child(1) > .text-right').click({scrollBehavior:false}).wait(2000)
        cy.contains('Ad Analytics').realHover({scrollBehavior:false}).wait(2000).should('have.css','background-color','rgb(244, 245, 247)')
        .click({scrollBehavior:false}).realMouseMove(200,200).wait(3000)
        cy.get('body').should('have.css', 'font').and('include','Poppins')
        ...
        // Funnel Analytics
        cy.get(':nth-child(1) > .text-right').click({scrollBehavior:false}).wait(2000)
        cy.contains('Funnel Analytics').realHover({scrollBehavior:false}).wait(2000).should('have.css','background-color','rgb(244, 245, 247)')
        .click({scrollBehavior:false}).realMouseMove(200,200).wait(3000)
        cy.get('body').should('have.css', 'font').and('include','Poppins')
        ...
        // A/B testing
        cy.get(':nth-child(1) > .text-right').click({scrollBehavior:false}).wait(2000)
        cy.contains('A/B Testing').realHover({scrollBehavior:false}).wait(2000).should('have.css','background-color','rgb(244, 245, 247)')
        .click({scrollBehavior:false}).realMouseMove(200,200).wait(3000)
        cy.get('body').should('have.css', 'font').and('include','Poppins')
        ...
        // Link Builder
        cy.get(':nth-child(1) > .text-right').click({scrollBehavior:false}).wait(2000)
        cy.contains('Link Builder').realHover({scrollBehavior:false}).wait(2000).should('have.css','background-color','rgb(244, 245, 247)')
        .click({scrollBehavior:false}).realMouseMove(200,200).wait(3000)
        cy.get('body').should('have.css', 'font').and('include','Poppins')
        ...
        cy.contains('Duplicate Project').realHover({scrollBehavior:false}).wait(2000).should('have.css','background-color','rgb(244, 245, 247)')
        .click({scrollBehavior:false}).realMouseMove(200,200).wait(3000)
        cy.get('body').should('have.css', 'font').and('include','Poppins')
        ...
        cy.get(':nth-child(1) > .text-right').click({scrollBehavior:false}).wait(500)
        cy.get(':nth-child(1) > .text-right > .relative > .absolute > .rounded-md').scrollIntoView().wait(2000)
        cy.contains('Delete Project').realHover({scrollBehavior:false}).wait(2000).should('have.css','background-color','rgb(244, 245, 247)')
        .click({scrollBehavior:false}).realMouseMove(200,200).wait(3000)
        cy.get('body').should('have.css', 'font').and('include','Poppins')
    ...
    StatusMessages()
    {
        ...
        cy.get('body').should('have.css', 'font').and('include','Poppins')
        cy.get(':nth-child(2) > :nth-child(13)').scrollIntoView().wait(2000)
        cy.get('#fbStatToggle > .toggle').click({scrollBehavior:false}).wait(2000)
        cy.get('#mcStatToggle > .toggle').click({scrollBehavior:false}).wait(2000)
        ...
        cy.get(':nth-child(1) > .text-right > .relative > .absolute > .rounded-md').scrollIntoView().wait(2000)
        cy.contains('Status Messages').realHover({scrollBehavior:false}).wait(2000).should('have.css','background-color','rgb(244, 245, 247)')
        .click({scrollBehavior:false}).realMouseMove(200,200).wait(2000)
    ...
    RefreshData()
    {
        ...
        cy.get('.text-right').click({scrollBehavior:false}).wait(500)
        cy.get(':nth-child(1) > .text-right > .relative > .absolute > .rounded-md').scrollIntoView().wait(2000)
        cy.contains('Refresh Data').realHover({scrollBehavior:false}).wait(2000).should('have.css','background-color','rgb(244, 245, 247)')
        .click({scrollBehavior:false}).realMouseMove(200,200).wait(2000)
