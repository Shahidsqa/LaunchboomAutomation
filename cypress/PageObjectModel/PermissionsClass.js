class Permissions {
    ...
    SettingPermissionsOff()
    {
       ...
       CheckingPermissionsOff()
       {
        ...
        cy.url().should('include','/2558/content')
        ...
        cy.visit('https://release.launchboom.com/admin/analytics-dashboard/2558',{failOnStatusCode: false}).wait(3000)
     ...
     SettingPermissionsOn()
    {
       ...
       CheckingPermissionsOn()
       {
        ...
        cy.get('.mb-4').should('include.text','Forbidden')
        cy.visit('https://release.launchboom.com/admin/projects/2558/campaign-ad-analysis',{failOnStatusCode: false}).wait(3000)
        cy.get('.mb-4').should('include.text','Forbidden')
