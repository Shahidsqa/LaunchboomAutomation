...
class LinkBuilder{
    ...
    CreateLink()
    {
        ...
        cy.get('#redirect_type').then($select => {
          ...
          cy.wait(2000)
        cy.get('.bkg-ylb').realHover({scrollBehavior:false}).wait(1000).click({scrollBehavior:false}).realMouseMove(100,100).wait(7000)
    ...
    CopyLink()
    {
       ...
       cy.get(':nth-child(6) > .link-div > .text-right > .copy-link').scrollIntoView().wait(2000).realHover().wait(2000).click().realMouseMove(200,200).wait(3000)
