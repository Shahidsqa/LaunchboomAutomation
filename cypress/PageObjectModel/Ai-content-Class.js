...
class AiContent{
  ...
  USP()
  {
    ...
    cy.get('#submit-btn').realHover().wait(1000).click().realMouseMove(100,100)
  ...
  SubmittingFormAgain()
  {
    ...
    cy.get('.top-steps-wrap > ul > :nth-child(3)').click({scrollBehavior:false}).wait(1000)
    ...
    cy.get('.top-steps-wrap > ul > :nth-child(4)').click({scrollBehavior:false}).wait(1000)
    ...
    cy.get('.swal2-confirm').realHover().wait(1000).click()
